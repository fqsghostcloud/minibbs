...
<script type="text/javascript">
  ...
  function inputBox(name, id) {
    ...
    htmlEle.innerHTML =
      "<form class='form-inline' role='form' action='/tag/manage/update' method='post'><div class='form-group'><label for='tagName'>标签名称</label><input type='text' class='form-control' name='tagName' id='tagName'><input type='hidden' name='id' value=" +
      id +
      "></div><button type='submit' class='btn btn-default'>提交</button><button id='cancle' type='submit' class='btn btn-default'>取消</button></form>"
  }
